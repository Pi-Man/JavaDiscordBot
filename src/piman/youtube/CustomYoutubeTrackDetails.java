...
public class CustomYoutubeTrackDetails implements YoutubeTrackDetails {
  private static final Logger log = LoggerFactory.getLogger(CustomYoutubeTrackDetails.class);
  ...
  public CustomYoutubeTrackDetails(String videoId, YoutubeTrackJsonData data, Captions captions) {
  ...
  private AudioTrackInfo loadTrackInfo() {
    ...
    return buildTrackInfo(videoId, videoDetails.get("title").text(), videoDetails.get("author").text(), temporalInfo, videoDetails, false, captions);
  }
  ...
  private AudioTrackInfo loadLegacyTrackInfo() {
    ...
    return buildTrackInfo(videoId, args.get("title").text(), args.get("author").text(), temporalInfo, args, true, captions);
  }

  private AudioTrackInfo buildTrackInfo(String videoId, String title, String uploader, TemporalInfo temporalInfo, JsonBrowser videoDetails, boolean legacy, Captions captions) {
